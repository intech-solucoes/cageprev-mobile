            ...
            <View style={styles.container}>
                <ScrollView>
                    ...
                    <MenuItem onPress={this.navigateToScreen('Home')} icon={faHome} title="Início" />
                        <MenuItem onPress={this.navigateToScreen('DadosPessoais')} icon={faUser} title="Seus Dados" />
                        <MenuItem onPress={this.navigateToScreen('Plano')} icon={faAddressBook} title="Seu Plano" />
                        <MenuItem onPress={this.navigateToScreen('Documentos')} icon={faFile} title="Documentos" />
                        ...
                        {(this.state.assistido || this.state.pensionista) && 
                            <MenuItem onPress={this.navigateToScreen('Contracheque')} icon={faClosedCaptioning} title="Demonstrativo de Pagamento" />}
